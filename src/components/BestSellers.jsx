    ...
    <section className="py-20 bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-white mb-4">Best Sellers</h2>
          ...
          {bestSellers.map((product, index) => (
            ...
            >
              <Link to={`/product/${product.id}`}>
                <div className="group bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-lg overflow-hidden border border-yellow-500/30 hover:border-yellow-500 transition-all duration-700 hover:scale-102 hover:shadow-lg hover:shadow-yellow-500/20">
                  {/* Top Badge */}
                  <div className="relative h-48 bg-neutral-700 overflow-hidden">
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-yellow-500/20 to-transparent flex items-center justify-center text-5xl group-hover:scale-110 transition-transform duration-500">
                  ...
                  {/* Content */}
                  <div className="p-5">
                    <h3 className="font-display text-xl text-white group-hover:text-yellow-500 transition-colors mb-1">
                      {product.name}
                    </h3>
                    ...
                    {/* Description */}
                    <p className="font-body text-gray-400 text-sm line-clamp-2 mb-4">
                      {product.description}
                    </p>
