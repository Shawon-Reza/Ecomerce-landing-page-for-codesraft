...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 border-b border-yellow-600/30 shadow-lg border-t border-yellow-500/20">
      {/* Main Footer */}
