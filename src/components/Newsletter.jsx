    ...
    <section className="py-20 bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative bg-gradient-to-br from-neutral-800 to-neutral-900 border border-yellow-500/30 rounded-xl p-12 overflow-hidden"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              <motion.div
                ...
                className="inline-block p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg mb-4"
              >
              ...
              <p className="font-body text-gray-300 max-w-xl mx-auto">
            ...
            <form onSubmit={handleSubscribe} className="max-w-lg mx-auto flex flex-col sm:flex-row gap-3">
              <div className="flex-grow">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-neutral-700 border border-yellow-500/30 text-white placeholder-gray-500 focus:outline-none focus:border-yellow-500 transition-colors"
                  required
                />
              </div>
              <motion.button
